              ...
              <div class="box-body row">
                ...
                <div class="col-8">
                  ...
                  <div class="input-group mb-2">
                    ...
                    <input v-model="current_payee_name" readonly type="text" class="form-control col-12" id="inputPayeeName" placeholder="Payees Name" v-bind:style="[readabilityObject]">
        ...
        methods: {
          ...
          savePayment(account_code,payment_amount)
          {
            ...
            this.transactions.push({ 
                ...
                status: 'CONFIRMED',
                depreciation_date: this.form.transaction_date,
                depreciated_id: this.current_purchase_id, // purchase_id needed for reverse transaction                 useful_life: 0,
                salvage_value: 0,
                description: '',
                taxed: 'NA',
                tax_of_id: 0,
